...
public class UndoCtrlZ {
	...
	static JFrame frame = new JFrame("Ctrl+Z Undo"); //instantiate frame
	static JTextArea txtArea = new JTextArea(); //instantiate textArea
	static final UndoManager undo = new UndoManager(); //instantiate an UndoManager
	static Document doc = txtArea.getDocument(); //instantiate a Document class of the txtArea
